...
class $AssetImageGen {
  ...
  /// File path: asset/image/dummyprofile.png
  AssetGenImage get dummyprofile =>
      const AssetGenImage('asset/image/dummyprofile.png');
...
class $AssetSoundGen {
  ...
  /// File path: asset/sound/beep.ogg
  String get beep => 'asset/sound/beep.ogg';
